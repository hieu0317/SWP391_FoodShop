...
<html lang="en">
    ...
    <body>
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <!-- Sidebar Start -->
            <div class="sidebar pe-4 pb-3" style="height: 600px;">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h6 class="mb-0">${helper.convertToVietnameseDong(requestScope.totaltoday)}</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h6 class="mb-0">${helper.convertToVietnameseDong(requestScope.total)}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
